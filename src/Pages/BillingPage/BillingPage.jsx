            ...
            <Box sx={{ marginTop: "45px" }} className="">
              <Grid container spacing={8}>
                <Grid item xs={12} md={7}>
                  <Box>
                    <span className="billing-details_text">
                      Billing Details
                    </span>
                  ...
                  <Box>
                    ...
                    <Box>
                      ...
                      >
                        ...
                        <span className="product-details_text-red">
                          Rs.140.00
                        </span>
                      </Box>
                    ...
                    >
                      <FormControl>
                        ...
                        >
                          ...
                          />
                          <FormControlLabel
                            value="Flat rate : Rs.100.00"
                            size="small"
                            control={<Radio />}
                            label="Flat rate : Rs.100.00"
                          />
                          <FormControlLabel
                            value="Local pickup : Rs.120.00"
                            size="small"
                            control={<Radio />}
                            label="Local pickup : Rs.120.00"
                          />
                        </RadioGroup>
                      </FormControl>
                    </Box>

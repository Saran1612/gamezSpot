...
const SingleProduct = () => {
  ...
  return (
    <Box className="cart-bg_img" sx={{ border: "none" }}>
      {stopped === true ? (
        <Box
          sx={{
            height: "60vh",
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ display: "flex", flexDirection: "column" }}>
                    ...
                    <Divider
                      sx={{ margin: "20px 0px", borderColor: "#9C9C9C" }}
                    />

                    <Box>
                      <span className="singleProd-desc_text">
                        HyperX Dual Chamber Drivers for more distinction and
                        less distortion. Signature Award-Winning HyperX comfort.
                        Durable aluminum frame with an expanded headband.
                        Detachable braided cable with....
                      </span>
                    ...
                    >
                      ...
                      <Box
                        sx={{
                          margin: { xs: "20px 0px", md: "0px 0px 0px 50px" },
                        }}

              ...
              <Box>
                <Accordion className="product_accordion">
                  <AccordionSummary
                    ...
                    id="panel1a-header"
                  >
                    <span className="filter-option_text">Filter by Color</span>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Box>
                      <FormControl>
              ...
              <Box>
                <Accordion className="product_accordion">
                  <AccordionSummary
                    ...
                    id="panel1a-header"
                  >
                    <span className="filter-option_text">Average Rating</span>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Box
                      sx={{
              ...
              <Box>
                <Accordion className="product_accordion">
                  <AccordionSummary
                    ...
                    id="panel1a-header"
                  >
                    <span className="filter-option_text">Filter by Price</span>
                  </AccordionSummary>
                  <AccordionDetails>
                    <Box sx={{ width: "100%" }}>
                      <Slider
                        ...
                        <CardActionArea className="cardActionArea">
                          <Box className="product-img">
                            ...
                            >
                              {isFavorited[index] ? (
                                <FavoriteIcon
                                  sx={{ color: "#FF003A", margin: "15px 20px" }}
                                />
                              ) : (
                                <FavoriteBorderIcon
                                  sx={{ color: "#FF003A", margin: "15px 20px" }}
